...
var lyricsData = [
  ...
  { text: "en ese puesto de centinela", time: 18 },
  { text: "algo cambio en mi", time: 27 },
  { text: "desde entonces estas en mi corazon", time: 32 },
  { text: "donde no te quiero dejar ir", time: 33 },
  ...
  { text: "simepre te esperare asi pasen siglos", time: 176 },
  { text: "porque se lo que quiero", time: 183 },
  { text: "y eres tu", time: 188 },
  { text: "Love x siempre", time: 140 },
];
